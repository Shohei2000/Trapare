...
STRIDE = 32
RESTORE_FROM = '/var/www/html/ASOAR_NEW/scripts/pretrained/indexnet_matting.pth.tar'
RESULT_DIR = '/var/www/html/ASOAR_NEW/scripts/examples/mattes'
...
image_path = ['/var/www/html/ASOAR_NEW/scripts/examples/images/'+df['img_name']]
trimap_path = ['/var/www/html/ASOAR_NEW/scripts/examples/trimaps/'+df['img_name']]
