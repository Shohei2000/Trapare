...
img = Image.open('/var/www/html/ASOAR_NEW/scripts/examples/images/'+image_path).convert('RGB')
img.save('/var/www/html/ASOAR_NEW/scripts/examples/images/'+image_path, quality=95)
img = cv2.imread('/var/www/html/ASOAR_NEW/scripts/examples/images/'+image_path, -1)
img = img[...,::-1] #BGR->RGB
h,w,_ = img.shape
#w,h = img.size
...
# ファイルの名前を設定 & パスの設定
path = '/var/www/html/ASOAR_NEW/scripts/examples/trimaps/'+image_path
#print(path)
