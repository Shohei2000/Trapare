...
<html>
    ...
    <body>
        ...
        <div class="container" style="text-align:center; margin-top:10vh;">
            <div class="row">
                <div class="col-sm-12">
                    <img src='./scripts/examples/armarkers/<?php echo $_SESSION['file_name']; ?>' alt="ARMarker" width="400px">
                </div>
                <div class="col-sm-12">
                    <a><?php echo $_SESSION['file_name']; ?></a>
                </div>
                <div class="col-sm-12">
                    <a href="./scripts/examples/armarkers/<?php echo $_SESSION['file_name']; ?>">QRを拡大</a>
                    <span>/</span>
                    ...
                    <a href="./scripts/examples/armarkers/<?php echo $_SESSION['file_name']; ?>" download="<?php echo $_SESSION['file_name']; ?>">QRを保存</a>
                    <span>/</span>
                    
                    <a href="./scripts/examples/skepng/<?php echo $_SESSION['file_name']; ?>" download="<?php echo $_SESSION['file_name']; ?>">透過pngを保存</a>
                    <span>/</span>
                    
                    <a href="ASOAR_ImageUplode2.php">トップへ戻る</a>
